...
<head>
    ...
    <title>Tambah Siswa - SMA PGRI 1 Subang</title>
        ...
        <form action="<?= base_url('admin/siswa/simpan') ?>" method="post">
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="kelas" class="form-control" placeholder="XII MIPA 2">
                </div>
                <div class="col-md-3">
            ...
            <div class="mt-4">
                <button type="submit" class="btn btn-dark rounded-pill px-5 py-2"><i class="fa-solid fa-save me-1"></i> Simpan</button>
            </div>
        </form>
    </div>
</div>
