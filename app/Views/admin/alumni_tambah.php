...
<head>
    ...
    <title>Tambah Alumni - SMA PGRI 1 Subang</title>
...
<div class="main-content">
    ...
    <div class="card-panel">
        <form action="<?= base_url('admin/alumni/simpan') ?>" method="post">
            <div class="row g-3">
                <div class="col-md-6"><label class="form-label">NISN</label><input type="text" name="nisn" class="form-control" required></div>
                <div class="col-md-6"><label class="form-label">Nama Alumni</label><input type="text" name="nama_alumni" class="form-control" required></div>
                <div class="col-md-4"><label class="form-label">Jenis Kelamin</label><select name="jenis_kelamin" class="form-select"><option value="L">Laki-laki</option><option value="P">Perempuan</option></select></div>
                <div class="col-md-4"><label class="form-label">Tahun Lulus</label><select name="tahun_lulus" class="form-select"><?php for($t=date('Y');$t>=2020;$t--): ?><option value="<?=$t?>"><?=$t?></option><?php endfor; ?></select></div>
                <div class="col-md-4"><label class="form-label">No. HP</label><input type="text" name="no_hp" class="form-control"></div>
                ...
                <div class="col-md-6" id="fieldInstansi"><label class="form-label">Nama Perusahaan/PT/Usaha</label><input type="text" name="nama_instansi" class="form-control"></div>
                <div class="col-md-6" id="fieldJurusan" style="display:none;"><label class="form-label">Jurusan Kuliah</label><input type="text" name="jurusan_kuliah" class="form-control"></div>
                <div class="col-md-6" id="fieldPosisi" style="display:none;"><label class="form-label">Posisi Pekerjaan</label><input type="text" name="posisi_kerja" class="form-control"></div>
                <div class="col-md-6" id="fieldTahunMasuk" style="display:none;"><label class="form-label">Tahun Masuk</label><select name="tahun_masuk" class="form-select"><?php for($t=date('Y');$t>=2020;$t--): ?><option value="<?=$t?>"><?=$t?></option><?php endfor; ?></select></div>
                <div class="col-md-6" id="fieldTahunLulusKuliah" style="display:none;"><label class="form-label">Tahun Lulus Kuliah</label><select name="tahun_lulus_kuliah" class="form-select"><option value="">-</option><?php for($t=date('Y')+4;$t>=2020;$t--): ?><option value="<?=$t?>"><?=$t?></option><?php endfor; ?></select></div>
            </div>
            <div class="mt-4"><button type="submit" class="btn btn-dark rounded-pill px-5 py-2"><i class="fa-solid fa-save me-1"></i> Simpan</button></div>
        </form>
    </div>
</div>
<script>
function toggleFields() {
    ...
    const label = document.getElementById('fieldInstansi').querySelector('.form-label');
