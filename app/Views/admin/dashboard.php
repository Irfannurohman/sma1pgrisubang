...
<head>
    ...
    <title>Dashboard Admin - SMA PGRI 1 Subang</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .sidebar-brand h5, .sidebar-brand small, .nav-item span, .sidebar-footer span { display: none; }
...
<div class="sidebar">
    ...
    <a href="<?= base_url('admin/dashboard') ?>" class="nav-item active"><i class="fa-solid fa-chart-pie"></i><span>Dashboard</span></a>
...
<div class="main-content">
    <div class="top-bar">
        ...
        <div class="admin-profile">
            ...
            <div>
                <strong style="font-size:14px;">Administrator</strong>
                <br><small style="color:var(--text-gray);">admin@smapgri1.sch.id</small>
            </div>
        </div>
    </div>
    ...
    <div class="stat-grid">
        ...
        <div class="stat-card">
            <div class="stat-icon" style="background:#f0fdf4;color:var(--secondary);"><i class="fa-solid fa-user-graduate"></i></div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-label">Respon Tracer Study</div>
        </div>
        <div class="stat-card">
            <div class="stat-icon" style="background:#fef2f2;color:#ef4444;"><i class="fa-solid fa-calendar"></i></div>
                ...
                <div class="timeline-item">
                    ...
                    <div>
                        ...
                        <br><small style="color:var(--text-gray);">
                            <?= $a['status_aktivitas'] ?>
                            <?= $a['nama_instansi'] ? ' - '.$a['nama_instansi'] : '' ?>
                        </small>
                    </div>
                </div>
                <?php endforeach; ?>
