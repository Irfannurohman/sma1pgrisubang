...
<div class="sidebar">
    ...
    <a href="<?= base_url('admin/pengaturan-kelulusan') ?>" class="nav-item active"><i class="fa-solid fa-clock"></i><span>Pengaturan Kelulusan</span></a>
    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="card-panel">
                ...
                <form action="<?= base_url('admin/pengaturan-kelulusan/simpan') ?>" method="POST">
                    <div class="row g-3">
                        <div class="col-md-6">
                ...
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('admin/pengaturan-kelulusan/hapus/'.$p['id']) ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus riwayat pengaturan ini?');" title="Hapus"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        </tbody>
    ...
    <div class="row mt-4">
        <div class="col-lg-6">
            <div class="card-panel" style="border-left: 4px solid var(--secondary);">
                ...
                <div class="mt-3">
                    <a href="<?= base_url('admin/siswa/import') ?>" class="btn btn-outline-success" style="font-weight:700;">
