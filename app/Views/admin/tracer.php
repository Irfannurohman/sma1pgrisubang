...
<div class="sidebar">
    ...
    <a href="<?= base_url('admin/tracer') ?>" class="nav-item active"><i class="fa-solid fa-clipboard-list"></i><span>Tracer Study</span></a>
...
<div class="main-content">
    <div class="top-bar">
        <div class="page-title">
            <h2>Tracer Study</h2>
            <p>Data responden tracer study alumni</p>
        </div>
    </div>
    ...
    <div class="stat-mini">
        ...
        <div class="stat-mini-item">
            <div class="num" style="color:<?= $warna[$st['status_setelah_lulus']] ?? '#64748b' ?>"><?= $st['total'] ?></div>
            <div class="lbl"><?= str_replace('_', ' ', $st['status_setelah_lulus']) ?></div>
        </div>
        <?php endforeach; ?>
    </div>
    <?php endif; ?>
    <div class="card-panel">
        <div class="table-responsive">
            <table class="table table-hover">
                <thead>
                    <tr><th>NISN</th><th>Nama</th><th>Tahun Lulus</th><th>Status</th><th>PT/Perusahaan</th><th>Aksi</th></tr>
                </thead>
                <tbody>
                    <?php if(!empty($tracer)): ?>
                        ...
                        <tr>
                            ...
                            <td><a href="<?= base_url('admin/tracer/hapus/'.$t['id']) ?>" class="btn btn-sm btn-outline-danger btn-action" onclick="return confirm('Hapus data ini?')"><i class="fa-solid fa-trash"></i></a></td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="6" class="text-center text-muted py-4">Belum ada data tracer study.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
